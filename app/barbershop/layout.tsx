...
const NAV = [
  ...
  { href: '/barbershop/combos',       label: 'Combos',         icon: Package },
  { href: '/barbershop/products',     label: 'Productos',      icon: ShoppingBag },
  { href: '/barbershop/promotions',   label: 'Promociones',    icon: Tag },
  { href: '/barbershop/clients',      label: 'Clientes',       icon: Users },
  { href: '/barbershop/barbers',      label: 'Mi Equipo',      icon: UserGroup },
...
function Package({ active }: { active?: boolean }) {
  return (
...
function ShoppingBag({ active }: { active?: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
...
function UserGroup({ active }: { active?: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
