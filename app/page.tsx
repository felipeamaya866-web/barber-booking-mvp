// app/page.tsx
// Página de inicio de Barber Booking — empresa
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .path-card.client { border-color: rgba(201,168,76,0.15); }
        ...
        .steps::before {
          ...
          right: 12.5%;
          height: 1px;
          background: linear-gradient(to right, transparent, var(--gold-dk), var(--gold), var(--gold-dk), transparent);
        }
        ...
        .cta-bg {
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse 60% 80% at 50% 50%, rgba(201,168,76,0.07), transparent 70%);
        }
      ...
      <nav>
        ...
        <ul className="nav-links">
          ...
          <li><a href="/barbershop" className="nav-cta">Panel dueño</a></li>
        </ul>
      </nav>
      ...
      <div className="hero" ref={heroRef}>
        ...
        <div className="hero-content">
          <div className="hero-badge">
            ✦ La plataforma de barberías #1 en Colombia
          </div>
          ...
          <p className="hero-sub">
            Gestiona tu barbería, recibe reservas 24/7 y haz crecer tu negocio
            con la plataforma más completa del mercado.
          </p>
          <div className="hero-actions">
            <a href="/barbershop" className="btn-primary">
              Registra tu barbería →
            </a>
            <a href="#para-ti" className="btn-secondary">
              Reservar una cita
            </a>
          </div>
        </div>
      ...
      <section id="para-ti">
        ...
        <h2 className="section-title reveal">
          Diseñado para<br />cada parte del negocio
        </h2>
        <p className="section-sub reveal">
          Tanto si eres dueño de una barbería como si buscas el mejor corte,
          BarberBooking tiene lo que necesitas.
        </p>

        <div className="paths">
          {/* BARBERO/DUEÑO */}
          <a href="/barbershop" className="path-card reveal">
            <div className="path-icon">💼</div>
            <h3 className="path-title">Soy dueño de barbería</h3>
            <p className="path-desc">
              Administra tu negocio, gestiona tu equipo y recibe reservas
          ...
          {/* CLIENTE */}
          <a href="#buscar" className="path-card client reveal reveal-delay-1">
            <div className="path-icon">✂️</div>
            <h3 className="path-title">Busco una barbería</h3>
            <p className="path-desc">
              Encuentra las mejores barberías cerca de ti, elige tu barbero
              favorito y reserva en segundos.
            </p>
            <ul className="path-features">
            ...
            <span className="path-cta">Buscar barberías →</span>
          </a>
        </div>
      </section>

      {/* ── BÚSQUEDA DE BARBERÍAS (clientes) ── */}
      <section id="buscar" style={{ paddingTop: 0 }}>
        <div style={{
          background: 'var(--gray-1)',
          border: '1px solid var(--gray-3)',
          borderRadius: 20,
          ...
          <p style={{ fontSize: 15, color: 'rgba(245,240,232,0.4)', marginBottom: 32 }}>
            Ingresa el nombre o slug de la barbería para reservar tu cita
          </p>
          <SearchBarberías />
        </div>
      </section>
      ...
      <section id="caracteristicas">
        ...
        <h2 className="section-title reveal">
          Todo lo que tu barbería<br />necesita para crecer
        </h2>
      ...
      <section id="como-funciona" style={{ background: 'var(--gray-1)', maxWidth: '100%', borderTop: '1px solid var(--gray-3)', borderBottom: '1px solid var(--gray-3)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <h2 className="section-title reveal" style={{ textAlign: 'center', maxWidth: '100%' }}>
            En 4 pasos tienes<br />tu barbería online
          </h2>
      ...
      <div className="cta-section">
        ...
        <div className="cta-box reveal">
          <h2 className="cta-title">
            ...
            <span style={{ color: 'var(--gold)' }}>más que una agenda</span>
          </h2>
          <p className="cta-sub">
            Únete a cientos de barberías que ya gestionan su negocio
            con BarberBooking. Empieza gratis hoy.
          </p>
          <a href="/barbershop" className="btn-primary" style={{ display: 'inline-block' }}>
...
// ── Componente buscador de barberías ──
function SearchBarberías() {
  const router = useRouter();
  ...
  return (
    <form onSubmit={handleSearch} style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
      <input
        ...
        placeholder="Ej: piplex, barberking, stylecut..."
        style={{
          flex: 1,
          minWidth: 200,
